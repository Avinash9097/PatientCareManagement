  ...
  return (
    <header className="h-14 bg-white border-b border-neutral-200 px-3 lg:px-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Alert Icon + Dropdown (expanded) */}
        <div className="relative">
          <button id="alertMenuBtn" className="relative w-9 h-9 flex items-center justify-center rounded-full hover:bg-neutral-100">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-neutral-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div id="alertDropdown" className="hidden absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-xl border border-neutral-200 z-50">
        ...
        {/* Missed Calls */}
        <div className="relative">
          <button id="missedCallsBtn" className="relative w-9 h-9 flex items-center justify-center rounded-full hover:bg-neutral-100">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-neutral-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div id="missedCallsDropdown" className="hidden absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-neutral-200 z-50">
            <div className="px-4 py-3 border-b border-neutral-200 flex items-center justify-between">
            ...
            <div className="max-h-80 overflow-y-auto">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-red-100 flex items-center justify-center">
                    <svg className="w-5 h-5 text-red-600" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                      <path d="M16 8l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <p className="text-sm font-medium text-neutral-900">Dr. Sarah Wilson</p>
                    <p className="text-xs text-neutral-600">Mobile: (555) 234-5678</p>
                    <p className="text-xs text-red-600 font-medium mt-1">Missed 10 minutes ago</p>
                  </div>
                  <button className="h-8 w-8 rounded-full bg-green-600 hover:bg-green-700 flex items-center justify-center">
              ...
              {/* more missed calls items could go here */}
            </div>
            <div className="px-4 py-3 border-t border-neutral-200">
        ...
        {/* WhatsApp Icon & Dropdown */}
        <div className="relative">
          <button id="whatsappBtn" className="relative w-9 h-9 flex items-center justify-center rounded-full hover:bg-neutral-100">
          ...
          <div id="whatsappDropdown" className="hidden absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-xl border border-neutral-200 z-50">
        ...
        {/* Video Call Icon */}
        <div className="relative">
          <button id="videoCallBtn" className="relative w-9 h-9 flex items-center justify-center rounded-full hover:bg-neutral-100">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-neutral-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div id="videoCallDropdown" className="hidden absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-neutral-200 z-50">
              ...
              <div className="p-3 hover:bg-neutral-50 border-b border-neutral-100 cursor-pointer">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="inline-flex items-center gap-1 text-xs text-green-600"><span className="w-2 h-2 rounded-full bg-green-500"></span>Active now - 5 participants</span>
                    </div>
                  </div>
                  <button className="h-8 w-8 rounded-full bg-green-600 hover:bg-green-700 flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                  </button>
                </div>
              </div>
            </div>
            <div className="px-4 py-3 border-t border-neutral-200">
              <button className="w-full text-center text-sm text-blue-600 hover:text-blue-700 font-medium">View all meetings</button>
            </div>
          </div>
        </div>
        ...
        {/* Email Icon */}
        <div className="relative">
          <button id="emailBtn" className="relative w-9 h-9 flex items-center justify-center rounded-full hover:bg-neutral-100">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-neutral-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div id="emailDropdown" className="hidden absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-xl border border-neutral-200 z-50">
              ...
              <div className="p-3 hover:bg-neutral-50 border-b border-neutral-100 cursor-pointer">
                <div className="flex gap-3">
                  <div className="w-8 h-8 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0">
                    <svg className="w-4 h-4 text-orange-600" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
        ...
        <div className="relative">
          <button id="userMenuBtn" className="flex items-center gap-2 h-9 px-3 rounded-xl hover:bg-neutral-100 transition-colors">
            ...
            <span id="userRoleDisplay" className="text-sm font-medium text-neutral-700">Admin</span>
            <svg className="w-4 h-4 text-neutral-500" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              <path d="M19 9l-7 7-7-7" />
            </svg>
          </button>

          <div id="userDropdown" className="hidden absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-neutral-200 py-2 z-50">
            <div className="px-4 py-3 border-b border-neutral-200">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-semibold">
                  <span id="userInitialsDropdown">A</span>
                </div>
                <div>
                  <div id="userEmailDisplay" className="text-sm font-semibold text-neutral-900">admin@xyz.com</div>
                  <div id="userRoleDropdown" className="text-xs text-neutral-500">Administrator</div>
                </div>
              </div>
            </div>
            <div className="py-1">
            ...
            <div className="border-t border-neutral-200 py-1">
              <button id="logoutBtn" className="w-full flex items-center gap-3 px-4 py-2 text-sm text-red-600 hover:bg-red-50">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
